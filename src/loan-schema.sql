...
CREATE TABLE loans(
    ...
    open_acc SMALLINT, pub_rec SMALLINT,
    revol_bal FLOAT (2),
    revol_util FLOAT (2),
    total_acc SMALLINT,
    initial_list_status VARCHAR (1),
    out_prncp FLOAT (2),
    out_prncp_inv FLOAT (2),
    total_pymnt FLOAT (2),
    ...
    pct_tl_nvr_dlq FLOAT (2),
    percent_bc_gt_75 FLOAT (2),
    ...
    sec_app_mths_since_last_major_derog SMALLINT,
    ...
    orig_projected_additional_accrued_interest FLOAT (2),
    hardship_payoff_balance_amount FLOAT (2),
    hardship_last_payment_amount FLOAT (2),
